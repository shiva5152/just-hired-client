...
import media_1 from "@/assets/images/logo/media_109.png";
import media_2 from "@/assets/images/logo/media_110.png";
import media_3 from "@/assets/images/logo/media_111.png";
import media_4 from "@/assets/images/logo/media_112.png";
import media_5 from "@/assets/images/logo/media_113.png";
...
function BrandIcon({ img, id }: { img: StaticImageData; id: string }) {
  return (
    ...
    >
      <Image src={img} alt="" height={41} width={40} className="lazy-img" />
    </div>
  );
}
